...
if not 'IP_SGBD' in os.environ:
    os.environ['IP_SGBD'] = '192.168.0.10'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'options': '-c search_path=universidade,public',
        },
...
# A cache tem duração padrão de 1 hora
DEFAULT_CACHE_VALID_TIME = 3600

def init_cache():
    # Inicializando o dicionário de chaves de cache
    if cache.get('CACHE_KEYS_DICT') is None:
        CACHE_KEYS_DICT = {}
